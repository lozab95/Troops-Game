		...
		{//collision
			...
			if (framecounter_bullet >25)
			{
				if(key[KEY_SPACE]) 
				{
					...
					storesoldier_x = soldier_a.position_x;
					storesoldier_y = soldier_a.position_y;

					masked_blit(bullet_a, buffer, 0, 0, storesoldier_x, storesoldier_y, bullet_a ->w, bullet_a ->h);
				}
			}
