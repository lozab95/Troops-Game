...
{  /* start of main */
	...
	*/
	...
	while ((!key[KEY_ESC])&&(hit_base<11))
	{
		...
		if ((soldier_a.bullet_t==1) && (soldier_a.bullet_1[0] > 1000))
		{
			soldier_a.bullet_1[0] +
				1;
			masked_blit(bullet_a, buffer, 0,0,soldier_f.bullet_1[0],soldier_f.bullet_1[1], bullet_f->w, bullet_f->h);
		}
		if ((soldier_f.bullet_t==1) && (soldier_f.bullet_1[0] > 1000))
		{
